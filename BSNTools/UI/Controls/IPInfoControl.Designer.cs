namespace BSNTools.UI.Controls
{
    partial class IPInfoControl
    {
        ...
        private void InitializeComponent()
        {
            ...
            IPSourceAddressLabel = new Label();
            ...
            IPSubnetsComboBox = new ComboBox();
            ...
            IPCalculationInfosTableLayoutPanel.Controls.Add(IPSourceAddressLabel, 0, 0);
            IPCalculationInfosTableLayoutPanel.Controls.Add(IPTotalsTextBoxExt, 1, 9);
            IPCalculationInfosTableLayoutPanel.Controls.Add(IPLastUsableAddressTextBoxExt, 1, 8);
            IPCalculationInfosTableLayoutPanel.Controls.Add(IPLastAddressTextBoxExt, 1, 7);
            IPCalculationInfosTableLayoutPanel.Controls.Add(IPFirstUsableAddressTextBoxExt, 1, 6);
            IPCalculationInfosTableLayoutPanel.Controls.Add(IPFirstAddressTextBoxExt, 1, 5);
            IPCalculationInfosTableLayoutPanel.Controls.Add(IPBroadcastAddressTextBoxExt, 1, 4);
            IPCalculationInfosTableLayoutPanel.Controls.Add(IPNetworkAddressTextBoxExt, 1, 3);
            IPCalculationInfosTableLayoutPanel.Controls.Add(IPNetmaskTextBoxExt, 1, 2);
            IPCalculationInfosTableLayoutPanel.Controls.Add(IPAddressCIDRTextBoxExt, 1, 1);
            IPCalculationInfosTableLayoutPanel.Controls.Add(IPTotalsLabel, 0, 9);
            IPCalculationInfosTableLayoutPanel.Controls.Add(IPLastUsableAddressLabel, 0, 8);
            IPCalculationInfosTableLayoutPanel.Controls.Add(IPLastAddressLabel, 0, 7);
            IPCalculationInfosTableLayoutPanel.Controls.Add(IPFirstUsableAddressLabel, 0, 6);
            IPCalculationInfosTableLayoutPanel.Controls.Add(IPFirstAddressLabel, 0, 5);
            IPCalculationInfosTableLayoutPanel.Controls.Add(IPBroadcastAddressLabel, 0, 4);
            IPCalculationInfosTableLayoutPanel.Controls.Add(IPNetworkAddressLabel, 0, 3);
            IPCalculationInfosTableLayoutPanel.Controls.Add(IPNetmaskLabel, 0, 2);
            IPCalculationInfosTableLayoutPanel.Controls.Add(IPAddressCIDRLabel, 0, 1);
            IPCalculationInfosTableLayoutPanel.Controls.Add(IPSubnetsComboBox, 1, 0);
            ...
            // 
            // IPSourceAddressLabel
            // 
            IPSourceAddressLabel.Anchor = AnchorStyles.Top | AnchorStyles.Bottom | AnchorStyles.Left | AnchorStyles.Right;
            IPSourceAddressLabel.AutoEllipsis = true;
            IPSourceAddressLabel.AutoSize = true;
            IPSourceAddressLabel.Font = new Font("Consolas", 9F, FontStyle.Regular, GraphicsUnit.Point, 0);
            IPSourceAddressLabel.Location = new Point(3, 0);
            IPSourceAddressLabel.Name = "IPSourceAddressLabel";
            IPSourceAddressLabel.Size = new Size(182, 32);
            IPSourceAddressLabel.TabIndex = 18;
            IPSourceAddressLabel.Text = "Kein Netzwerk berechnet";
            IPSourceAddressLabel.TextAlign = ContentAlignment.MiddleLeft;
            // 
            // IPTotalsTextBoxExt
            // 
            IPTotalsTextBoxExt.Anchor = AnchorStyles.Left | AnchorStyles.Right;
            ...
            IPTotalsTextBoxExt.Location = new Point(191, 297);
            ...
            // 
            IPLastUsableAddressTextBoxExt.Anchor = AnchorStyles.Left | AnchorStyles.Right;
            ...
            IPLastUsableAddressTextBoxExt.Location = new Point(191, 261);
            ...
            // 
            IPLastAddressTextBoxExt.Anchor = AnchorStyles.Left | AnchorStyles.Right;
            ...
            IPLastAddressTextBoxExt.Location = new Point(191, 229);
            ...
            // 
            IPFirstUsableAddressTextBoxExt.Anchor = AnchorStyles.Left | AnchorStyles.Right;
            ...
            IPFirstUsableAddressTextBoxExt.Location = new Point(191, 197);
            ...
            // 
            IPFirstAddressTextBoxExt.Anchor = AnchorStyles.Left | AnchorStyles.Right;
            ...
            IPFirstAddressTextBoxExt.Location = new Point(191, 165);
            ...
            // 
            IPBroadcastAddressTextBoxExt.Anchor = AnchorStyles.Left | AnchorStyles.Right;
            ...
            IPBroadcastAddressTextBoxExt.Location = new Point(191, 133);
            ...
            // 
            IPNetworkAddressTextBoxExt.Anchor = AnchorStyles.Left | AnchorStyles.Right;
            ...
            IPNetworkAddressTextBoxExt.Location = new Point(191, 101);
            ...
            // IPNetmaskTextBoxExt
            // 
            IPNetmaskTextBoxExt.Anchor = AnchorStyles.Left | AnchorStyles.Right;
            ...
            IPNetmaskTextBoxExt.Location = new Point(191, 69);
            ...
            // 
            IPAddressCIDRTextBoxExt.Anchor = AnchorStyles.Left | AnchorStyles.Right;
            ...
            IPAddressCIDRTextBoxExt.Location = new Point(191, 37);
            ...
            IPTotalsLabel.Location = new Point(3, 288);
            IPTotalsLabel.Name = "IPTotalsLabel";
            IPTotalsLabel.Size = new Size(182, 40);
            ...
            IPLastUsableAddressLabel.Location = new Point(3, 256);
            ...
            IPLastAddressLabel.Location = new Point(3, 224);
            ...
            IPFirstUsableAddressLabel.Location = new Point(3, 192);
            ...
            IPFirstAddressLabel.Location = new Point(3, 160);
            ...
            IPBroadcastAddressLabel.Location = new Point(3, 128);
            ...
            IPNetworkAddressLabel.Location = new Point(3, 96);
            ...
            IPNetmaskLabel.Location = new Point(3, 64);
            ...
            IPAddressCIDRLabel.Location = new Point(3, 32);
            ...
            // IPSubnetsComboBox
            // 
            IPSubnetsComboBox.Anchor = AnchorStyles.Left | AnchorStyles.Right;
            IPSubnetsComboBox.DropDownStyle = ComboBoxStyle.DropDownList;
            IPSubnetsComboBox.Enabled = false;
            IPSubnetsComboBox.Font = new Font("Consolas", 9F);
            IPSubnetsComboBox.FormattingEnabled = true;
            IPSubnetsComboBox.Location = new Point(191, 5);
            IPSubnetsComboBox.Name = "IPSubnetsComboBox";
            IPSubnetsComboBox.Size = new Size(254, 22);
            IPSubnetsComboBox.TabIndex = 19;
            IPSubnetsComboBox.SelectedIndexChanged += IPSubnetsComboBox_SelectedIndexChanged;
            // 
            // IPInfoControl
            // 
        ...
        private Label IPSourceAddressLabel;
        private ComboBox IPSubnetsComboBox;
